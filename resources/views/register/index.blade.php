        ...
        <div class="w-11/12 p-5 md:w-3/6 h-fit pb-12 m-auto border border-gray-200 bg-white rounded-lg shadow-lg">
            ...
            <form action="" class="mt-16 flex flex-col gap-7" method="POST">
                ...
                <div class="flex flex-col sm:flex-row gap-3 items-center">
                    <label for="" class="text-gray-600 w-3/12 text-xl font-bold text-center">Nombre: </label>
                    <input type="text" name="nombre" class="bg-gray-100 w-11/12 rounded-md sm:w-6/12 p-3 border px-3" placeholder="Ingresa tu correo">
                </div>
                @error('apellidos')
                    <x-mostrar-alertas :message="$message"/>
                @enderror
                <div class="flex flex-col sm:flex-row gap-3 items-center">
                    <label for="" class="text-gray-600 w-3/12 text-xl font-bold text-center">Apellidos: </label>
                    <input type="text" name="apellidos" class="bg-gray-100 w-11/12 rounded-md sm:w-6/12 p-3 border px-3" placeholder="Ingresa tu correo">
                </div>
